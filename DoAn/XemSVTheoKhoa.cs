...
namespace DoAn
{
    public partial class ReportSV : Form
    {
        ...
        private void ReportSV_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Lop lop = dbSinhVien.Lop.FirstOrDefault(p => p.MaLop == cbbMaLop.Text);
            List<SinhVien> SinhVien = dbSinhVien.SinhVien.Where(p => p.MaLop == cbbMaLop.Text).ToList();//sua thanh cbb ma lop
            ...
            this.reportViewer1.LocalReport.ReportPath = "ReportTTSV.rdlc";
            var reportDataSource = new ReportDataSource("DataSetTTSV", studentReports);
